...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!triggers.length || !overlay || !closeButton || !titleElement || !descriptionElement || !metaElement) {
        return;
    }
    ...
    const projectData = {
        csci181p1: {
            ...
            description: 'A software engineering project focused on clean structure, maintainability, and practical problem solving.',
        ...
        csci181p2: {
            ...
            description: 'A continuation of course work with deeper implementation of modal complexity.',
            stack: 'HTML, CSS, JavaScript',
            status: 'Completed',
        ...
        dsa: {
            ...
            description: 'A placeholder for your repository that demonstrates core algorithmic thinking, complexity analysis, and data structure implementations.',
            stack: 'Python',
        ...
        csci152: {
            ...
            description: 'A placeholder for your CSCI 152 work showcasing applied programming concepts and class-based outcomes.',
            stack: 'Java',
            status: 'In Progress (Placeholder)',
            repo: ''
        }
